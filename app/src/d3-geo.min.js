...
!(function (n, t) {
  ...
  var Tn = {
    ...
    lineEnd: Xn,
    polygonStart: function () {
      (Tn.lineStart = Yn), (Tn.lineEnd = Bn);
    },
    polygonEnd: function () {
      (Tn.lineStart = Hn), (Tn.lineEnd = Xn);
    },
  };
  function kn(n, t) {
    n *= l;
  ...
  function Fn(n, t, r) {
    (sn += (n - sn) / ++fn), (hn += (t - hn) / fn), (gn += (r - gn) / fn);
  }
  function Hn() {
    Tn.point = In;
  }
  ...
  function Bn() {
    Un(Mn, xn), (Tn.point = kn);
  }
  function Dn(n, t) {
    (Mn = n), (xn = t), (n *= l), (t *= l), (Tn.point = Un);
    var r = h(t);
      ...
      if ((x = (M = n[y]).length))
        for (
          ...
          if (
            ...
            var I = un(g, H);
            ln(I);
            var W = (k ^ (O >= 0) ? -1 : 1) * _(I[2]);
            (f > W || (f === W && (H[0] || H[1]))) &&
              (d += k ^ (O >= 0) ? 1 : -1);
          }
        }
    return (v < -r || (v < r && E < -e)) ^ (1 & d);
  }
  function pt(n, r, e, i) {
    return function (o) {
      var u,
  ...
  function Rt(n) {
    return (dt = new t.Adder()), z(n, wt), +dt;
  }
  var Ct = [null, null],
  ...
  var qt = {
      Feature: function (n, t) {
        return bt(n.geometry, t);
      },
      FeatureCollection: function (n, t) {
        for (var r = n.features, e = -1, i = r.length; ++e < i; )
          if (bt(r[e].geometry, t)) return !0;
        return !1;
      },
    },
    zt = {
      ...
      Polygon: function (n, t) {
        return Gt(n.coordinates, t);
      },
      MultiPolygon: function (n, t) {
        for (var r = n.coordinates, e = -1, i = r.length; ++e < i; )
          if (Gt(r[e], t)) return !0;
        return !1;
      },
      GeometryCollection: function (n, t) {
  ...
  function bt(n, t) {
    return !(!n || !zt.hasOwnProperty(n.type)) && zt[n.type](n, t);
  }
  function Lt(n, t) {
    return 0 === jt(n, t);
  }
  ...
  function Gr(n, t) {
    (Or.point = Tr), (jr = zr = n), (qr = br = t);
  }
  function Tr(n, t) {
    (zr -= n), (br -= t), Lr.add(M(zr * zr + br * br)), (zr = n), (br = t);
  }
  function kr() {
    this._string = [];
  }
          ...
          function e(i, o, u, a, c, l, p, h, g, v, d, E, y, S) {
            ...
            if (w > 4 * t && y--) {
              ...
              ((G * G) / w > t ||
                f((m * L + x * O) / w - 0.5) > 0.3 ||
                a * v + c * d + l * E < Zr) &&
                (e(i, o, u, a, c, l, z, b, j, (N /= C), (A /= C), R, y, S),
                S.point(z, b),
                e(z, b, j, N, A, R, p, h, g, v, d, E, y, S));
            }
          }
          return function (t) {
            var r,
            ...
            function x() {
              e(f, p, l, s, h, g, i, o, r, u, a, c, Ur, t),
                (v.lineEnd = S),
                S();
            }
            return v;
  ...
  function $r(n) {
    ...
    function z() {
      var n = Qr(h, 0, 0, w, _, x).apply(null, t(d, E)),
        e = Qr(h, g - n[0], v - n[1], w, _, x);
      return (
        (r = Qn(y, S, m)), (a = Jn(t, e)), (f = Jn(r, a)), (u = Jr(a, P)), b()
      );
    }
    function b() {
      return (p = s = null), j;
    ...
    return (
      ...
      (j.preclip = function (n) {
        return arguments.length ? ((A = n), (N = void 0), b()) : A;
      }),
      (j.postclip = function (n) {
        return arguments.length ? ((C = n), (R = e = i = o = null), b()) : C;
      }),
      (j.clipAngle = function (n) {
        return arguments.length
          ? ((A = +n ? vt((N = n * l)) : ((N = null), gt)), b())
          : N * c;
      }),
      ...
      (j.angle = function (n) {
        return arguments.length ? ((x = (n % 360) * l), z()) : x * c;
      }),
      (j.reflectX = function (n) {
        return arguments.length ? ((w = n ? -1 : 1), z()) : w < 0;
      }),
      (j.reflectY = function (n) {
        return arguments.length ? ((_ = n ? -1 : 1), z()) : _ < 0;
      }),
      (j.precision = function (n) {
        return arguments.length ? ((u = Jr(a, (P = n * n))), b()) : M(P);
      }),
  ...
  function re() {
    return ne(te).scale(155.424).center([0, 33.6442]);
  }
  function ee() {
    return re()
      .parallels([29.5, 45.5])
  ...
  var ue = ie(function (n) {
    return M(2 / (1 + n));
  });
  ue.invert = oe(function (n) {
    return 2 * _(n / 2);
  });
  var ae = ie(function (n) {
    return (n = w(n)) && n / S(n);
  });
  function ce(n, t) {
    return [n, E(x((o + t) / 2))];
  ...
  function Se(n, t) {
    var r = _(ye * S(t)),
      ...
      i = e * e * e;
    return [
      (n * h(r)) / (ye * (ge + 3 * ve * e + i * (7 * de + 9 * Ee * e))),
      r * (ge + ve * e + i * (de + Ee * e)),
    ];
  }
  function me(n, t) {
  ...
  (Se.invert = function (n, t) {
    for (
      ...
      ((u =
        (o =
          (i -= r =
            (i * (ge + ve * o + u * (de + Ee * o)) - t) /
            (ge + 3 * ve * o + u * (7 * de + 9 * Ee * o))) * i) *
        o *
        o),
      !(f(r) < e));
      ++a
    ...
    return [
      (ye * n * (ge + 3 * ve * o + u * (7 * de + 9 * Ee * o))) / h(i),
      _(S(i) / ye),
    ];
  }),
    (me.invert = oe(p)),
    ...
    (n.geoAlbersUsa = function () {
      var n,
        ...
        u,
        a = ee(),
        c = re().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
        l = re().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
        f = {
          point: function (n, t) {
            u = [n, t];
          },
      ...
      return (
        (p.invert = function (n) {
          var t = a.scale(),
            ...
            e = (n[0] - r[0]) / t,
            i = (n[1] - r[1]) / t;
          return (i >= 0.12 && i < 0.234 && e >= -0.425 && e < -0.214
            ? c
    ...
    (n.geoArea = function (n) {
      return (K = new t.Adder()), z(n, Q), 2 * K;
    }),
    (n.geoAzimuthalEqualArea = function () {
      return Vr(ue).scale(124.75).clipAngle(179.999);
    }),
    (n.geoAzimuthalEqualAreaRaw = ue),
    (n.geoAzimuthalEquidistant = function () {
      return Vr(ae).scale(79.4188).clipAngle(179.999);
    }),
    (n.geoAzimuthalEquidistantRaw = ae),
    (n.geoBounds = function (n) {
      var t, r, e, i, o, u, a;
      if (((I = H = -(k = F = 1 / 0)), (U = []), z(n, An), (r = U.length))) {
        for (U.sort(On), t = 1, o = [(e = U[0])]; t < r; ++t)
          Gn(e, (i = U[t])[0]) || Gn(e, i[1])
    ...
    (n.geoConicConformal = function () {
      return ne(pe).scale(109.5).parallels([30, 30]);
    }),
    (n.geoConicConformalRaw = pe),
    (n.geoConicEqualArea = re),
    (n.geoConicEqualAreaRaw = te),
    (n.geoConicEquidistant = function () {
      return ne(he).scale(131.154).center([0, 13.9389]);
    }),
    (n.geoConicEquidistantRaw = he),
    (n.geoContains = function (n, t) {
      return (n && qt.hasOwnProperty(n.type) ? qt[n.type] : bt)(n, t);
    }),
    (n.geoDistance = jt),
    (n.geoEqualEarth = function () {
      return Vr(Se).scale(177.158);
    }),
    (n.geoEqualEarthRaw = Se),
    (n.geoEquirectangular = function () {
      return Vr(se).scale(152.63);
    }),
    (n.geoEquirectangularRaw = se),
    (n.geoGnomonic = function () {
      return Vr(me).scale(144.049).clipAngle(60);
    }),
    (n.geoGnomonicRaw = me),
    (n.geoGraticule = It),
    ...
    (n.geoMercator = function () {
      return le(ce).scale(961 / a);
    }),
    (n.geoMercatorRaw = ce),
    (n.geoNaturalEarth1 = function () {
      return Vr(Me).scale(175.295);
    }),
    ...
    (n.geoPath = function (n, t) {
      ...
      return (
        (o.area = function (n) {
          return z(n, r(Jt)), Jt.result();
        }),
        (o.measure = function (n) {
          return z(n, r(Or)), Or.result();
        }),
        (o.bounds = function (n) {
          return z(n, r(ir)), ir.result();
        }),
        (o.centroid = function (n) {
          return z(n, r(yr)), yr.result();
        }),
    ...
    (n.geoProjection = Vr),
    (n.geoProjectionMutator = $r),
    (n.geoRotation = tt),
    (n.geoStereographic = function () {
      return Vr(we).scale(250).clipAngle(142);
    }),
    (n.geoStereographicRaw = we),
    (n.geoStream = z),
