  ...
  render: (className = "container", ...rest) => {
    ...
    <section class="${className}">
      ...
      <div class="container-modal modal_closed">
        ...
        <div class="modal modal_closed" id="modalResult">
          <div class="modal_header">
            <a href="#" class="modal__close" id="modalResult-close" title="Закрыть модальное окно">Закрыть</a>
            <h2>Ваш результат:</h2>            
          </div>
          <div class="modalResult_content"></div>
        </div>

        <div class="modal modal_closed" id="modalAttention">
          <div class="modal_header">
            <a href="#" class="modal__close" id="modalAttention-close" title="Закрыть модальное окно">Закрыть</a>
            <h2>Внимание!</h2>            
          </div>
